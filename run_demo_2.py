...
from src.pipeline import visualize_result_2 as vis
...
if __name__ == '__main__':
    ...
    config_path = '/mnt/nas_siddharth/tracking_gt/calib/config.yaml' 

    raw_data_dir= '/mnt/nas_siddharth/tracking_gt/rawdata'
    data_name = 'gp1d_20211015_170000'
